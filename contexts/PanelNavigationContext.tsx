 ...
 * 
 * Provides panel navigation state for AppSplit screens (dual left/right panel layouts).
 ...
 */
export interface PanelNavigationContextType {
...
export interface PanelNavigationProviderProps {
 ...
 * Usage:
 * ```tsx
 * const { showRightPanel, goToRightPanel, handleBackPress } = usePanelNavigation();
 * ```
 *
